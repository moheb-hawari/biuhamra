...
// ! GENERAL SETTINGS
//------------------------------------------------------------------------------
$lang['bf_site_name'] = 'اسم الموقع';
$lang['bf_site_email'] = 'ايميل الموقع';
...
// Login
//------------------------------------------------------------------------------
$lang['bf_action_register'] = 'تسجيل';
$lang['bf_forgot_password'] = 'هل نسيت كلمة السر؟';
$lang['bf_remember_me'] = 'تذكرني';
