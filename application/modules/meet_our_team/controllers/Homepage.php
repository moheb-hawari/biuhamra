...
{
    protected $permissionCreate = 'Meet_our_team.Homepage.Create';
    protected $permissionDelete = 'Meet_our_team.Homepage.Delete';
    protected $permissionEdit   = 'Meet_our_team.Homepage.Edit';
    protected $permissionView   = 'Meet_our_team.Homepage.View';
    ...
    public function __construct()
    {
        ...
        Template::set_block('sub_nav', 'homepage/_sub_nav');
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/homepage/meet_our_team/index') . '/';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            if ($insert_id = $this->save_meet_our_team()) {
                ...
                redirect(SITE_AREA . '/homepage/meet_our_team');
            }
