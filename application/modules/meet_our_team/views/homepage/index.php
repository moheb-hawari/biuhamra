...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Meet_Our_Team.Homepage.Delete');
$can_edit		= $this->auth->has_permission('Meet_Our_Team.Homepage.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped display datatables-basic'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/homepage/meet_our_team/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->en_title); ?></td>
				<?php else : ?>
