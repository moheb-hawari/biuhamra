...
<div class="col-md-6">
    ...
    <div class="inputer floating-label control-group<?php echo form_error('email') ? $errorClass : ''; ?>">
    ...
    <div class="inputer floating-label control-group<?php echo form_error('password') ? $errorClass : ''; ?>">
    ...
    <div class="control-group<?php echo form_error('language') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <select name="language" id="language" class="selectpicker <?php echo $controlClass; ?>">
    ...
    ?>
    <div class="inputer floating-label control-group<?php echo form_error('display_name') ? $errorClass : ''; ?>">
...
<div class="col-md-6">
    ...
    <div class="inputer floating-label control-group<?php echo form_error('username') ? $errorClass : ''; ?>">
    ...
    <?php endif; ?>
    <div style="padding-bottom: 27px;" class="inputer floating-label control-group<?php echo form_error('pass_confirm') ? $errorClass : ''; ?>">
