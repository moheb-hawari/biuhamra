...
<?php
    ...
    echo form_open();
?>
    <table class="table table-striped user-table display datatables-basic">
		<thead>
			<tr>
		...
		<tfoot>
			<tr>
                <td colspan="<?php echo $numColumns; ?>">
					...
					?>
                    <button type="submit" name="restore" class="btn" value="<?php echo lang('bf_action_restore'); ?>" ><?php echo lang('bf_action_restore'); ?></button>
					<button type="submit" name="purge" class="btn btn-danger" value="<?php echo lang('bf_action_purge'); ?>" onclick="return confirm('<?php e(js_escape(lang('us_purge_del_confirm'))); ?>')" ><?php echo lang('bf_action_purge'); ?></button>
					<?php else : ?>
					<button type="submit" name="activate" class="btn" value="<?php echo lang('bf_action_activate'); ?>" ><?php echo lang('bf_action_activate'); ?></button>
					<button type="submit" name="deactivate" class="btn" value="<?php echo lang('bf_action_deactivate'); ?>" ><?php echo lang('bf_action_deactivate'); ?></button>
					<button type="submit" name="ban" class="btn" value="<?php echo lang('bf_action_ban'); ?>" ><?php echo lang('bf_action_ban'); ?></button>
					<button type="submit" name="delete" class="btn btn-danger" id="delete-me" value="<?php echo lang('bf_action_delete'); ?>" onclick="return confirm('<?php e(js_escape(lang('us_delete_account_confirm'))); ?>')" ><?php echo lang('bf_action_delete'); ?></button>
					<?php endif;?>
				</td>
			</tr>
		</tfoot>
