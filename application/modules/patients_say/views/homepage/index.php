...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('Patients_Say.Homepage.Delete');
$can_edit		= $this->auth->has_permission('Patients_Say.Homepage.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped display datatables-basic'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/homepage/patients_say/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->en_name); ?></td>
				<?php else : ?>
