...
{
    protected $permissionCreate = 'Patients_say.Homepage.Create';
    protected $permissionDelete = 'Patients_say.Homepage.Delete';
    protected $permissionEdit   = 'Patients_say.Homepage.Edit';
    protected $permissionView   = 'Patients_say.Homepage.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/homepage/patients_say/index') . '/';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            if ($insert_id = $this->save_patients_say()) {
                ...
                redirect(SITE_AREA . '/homepage/patients_say');
            }
