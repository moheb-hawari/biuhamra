...
<div class='admin-box panel'>
	...
	<h3>
		<div class='panel-title'><?php echo lang('{$module_name_lower}_area_title'); ?></div>
	</h3>
    </div>
			...
			<tfoot>
				...
				<tr>
					<td colspan='<?php echo \$num_columns; ?>'>
						...
						<button type='submit' name='delete' id='delete-me' class='btn btn-danger' value=\"<?php echo lang('bf_action_delete'); ?>\" onclick=\"return confirm('<?php e(js_escape(lang('{$module_name_lower}_delete_confirm'))); ?>')\" ><?php echo lang('bf_action_delete'); ?></button>
					</td>
				</tr>
				<?php endif; ?>
			</tfoot>
