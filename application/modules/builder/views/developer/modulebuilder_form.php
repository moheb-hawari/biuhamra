...
// up other pages
?>
<div class='module-builder panel'>
    <div class='panel-heading'>
        <div class='panel-title'><p class="intro"><?php e(lang('mb_create_note')); ?></p></div>
    </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls" id='mb_module_db'>
                        ...
                        <label class="inline radio" for="db_create">
                            <input name="module_db" id="db_create" type="radio" value="new" <?php echo set_radio('module_db', 'new'); ?> class="radio" checked />
                ...
                <div class="control-group mb_advanced">
                    <div class="controls">
                        <label for="use_pagination" class="checkbox">
                            <input type='checkbox' name="use_pagination" id="use_pagination" checked value="1" <?php echo set_checkbox('use_pagination', 1); ?> />
                ...
                <div class="control-group mb_advanced">
                    <div class="controls">
                        <label for="log_user" class="checkbox">
                            <input type='checkbox' name="log_user" id="log_user" checked value='1' <?php echo set_checkbox('log_user', 1); ?> />
                ...
                <div class="control-group mb_advanced">
                    <div class="controls">
                        <label for="use_soft_deletes" class="checkbox">
                            <input type='checkbox' name="use_soft_deletes" id="use_soft_deletes" checked value='1' <?php echo set_checkbox('use_soft_deletes', 1); ?> />
                ...
                <div class="control-group mb_advanced">
                    <div class="controls">
                        <label for="use_created" class="checkbox">
                            <input type='checkbox' name="use_created" id="use_created" checked value='1' <?php echo set_checkbox('use_created', 1); ?> />
                ...
                <div class="control-group mb_advanced">
                    <div class="controls">
                        <label for="use_modified" class="checkbox">
                            <input type='checkbox' name="use_modified" id="use_modified" checked value='1' <?php echo set_checkbox('use_modified', 1); ?> />
