...
class Migration_Install_administration_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Administration.Humanresources.View',
			'description' => 'View Administration Humanresources',
			'status' => 'active',
		),
    );
