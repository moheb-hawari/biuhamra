...
{
    protected $permissionCreate = 'Slider.Homepage.Create';
    protected $permissionDelete = 'Slider.Homepage.Delete';
    protected $permissionEdit   = 'Slider.Homepage.Edit';
    protected $permissionView   = 'Slider.Homepage.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/homepage/slider/index') . '/';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            if ($insert_id = $this->save_slider()) {
                ...
                redirect(SITE_AREA . '/homepage/slider');
            }
