    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('en_ddress') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <?php echo form_textarea(array('name' => 'en_ddress', 'id' => 'en_ddress', 'class'=> 'summernote summernote-default','rows' => '5', 'cols' => '80', 'value' => set_value('en_ddress', isset($information->en_ddress) ? $information->en_ddress : ''), 'required' => 'required')); ?>
            ...
            <div class="control-group<?php echo form_error('ar_ddress') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <?php echo form_textarea(array('name' => 'ar_ddress', 'id' => 'ar_ddress', 'class'=> 'summernote summernote-default','rows' => '5', 'cols' => '80', 'value' => set_value('ar_ddress', isset($information->ar_ddress) ? $information->ar_ddress : ''), 'required' => 'required')); ?>
                    <span class='help-inline'><?php echo form_error('ar_ddress'); ?></span>
                </div>
            </div>
        </fieldset>
        <fieldset class='form-actions'>
            <input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('information_action_create'); ?>" />
            <?php echo lang('bf_or'); ?>
