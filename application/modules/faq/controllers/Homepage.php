...
{
    protected $permissionCreate = 'Faq.Homepage.Create';
    protected $permissionDelete = 'Faq.Homepage.Delete';
    protected $permissionEdit   = 'Faq.Homepage.Edit';
    protected $permissionView   = 'Faq.Homepage.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/homepage/faq/index') . '/';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            if ($insert_id = $this->save_faq()) {
                ...
                redirect(SITE_AREA . '/homepage/faq');
            }
