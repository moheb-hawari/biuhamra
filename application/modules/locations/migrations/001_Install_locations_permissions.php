...
class Migration_Install_locations_permissions extends Migration
{
	...
	private $permissionValues = array(
		array(
			'name' => 'Locations.Utility.View',
			'description' => 'View Locations Utility',
			'status' => 'active',
		),
		array(
			'name' => 'Locations.Utility.Create',
			'description' => 'Create Locations Utility',
			'status' => 'active',
		),
		array(
			'name' => 'Locations.Utility.Edit',
			'description' => 'Edit Locations Utility',
			'status' => 'active',
		),
		array(
			'name' => 'Locations.Utility.Delete',
			'description' => 'Delete Locations Utility',
			'status' => 'active',
		),
    );
