        ...
        <fieldset>
            <div id="english-content" class="col-md-12">
                ...
                <div class="control-group<?php echo form_error('en_description') ? ' error' : ''; ?>">
                    ...
                    <div class=''>
                        <div class="rtl-support">
                            <textarea  class="summernote summernote-default" id="en_description" name='en_description'><?php echo set_value('en_description', isset($about->en_description) ? $about->en_description : ''); ?></textarea>
                        </div>
                ...
                <div class="control-group<?php echo form_error('en_hours') ? ' error' : ''; ?>">
                    ...
                    <div class=''>
                        <div class="rtl-support">
                            <textarea  class="summernote summernote-default" id="en_hours" name='en_hours'><?php echo set_value('en_hours', isset($about->en_hours) ? $about->en_hours : ''); ?></textarea>
                        </div>
            ...
            <div  id="arabic-content" class="col-md-12">
                ...
                <div class="control-group<?php echo form_error('ar_description') ? ' error' : ''; ?>">
                    ...
                    <div class=''>
                        <div class="rtl-support">
                            <textarea  class="summernote summernote-default" id="ar_description" name='ar_description'><?php echo set_value('ar_description', isset($about->ar_description) ? $about->ar_description : ''); ?></textarea>
                        </div>
                ...
                <div class="control-group<?php echo form_error('ar_hours') ? ' error' : ''; ?>">
                    ...
                    <div class="rtl-support">
                            <textarea  class="summernote summernote-default" id="ar_hours" name='ar_hours'><?php echo set_value('ar_hours', isset($about->ar_hours) ? $about->ar_hours : ''); ?></textarea>
                        </div>
