...
{
    protected $permissionCreate = 'About.Homepage.Create';
    protected $permissionDelete = 'About.Homepage.Delete';
    protected $permissionEdit   = 'About.Homepage.Edit';
    protected $permissionView   = 'About.Homepage.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/homepage/about/index') . '/';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            if ($insert_id = $this->save_about()) {
                ...
                redirect(SITE_AREA . '/homepage/about');
            }
