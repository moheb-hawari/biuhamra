            ...
            <div class="wb_nv_cont">
                ...
                <div class="nav_lks">
                    <ul class="nav_lk_list">
                        ...
                        <li class="scroll_to_sec_about_clinic" <?=($this->uri->segment(2) == 'about')?' class="active"':'';?>><a href="<?php echo site_url().'/'.lang('bf_language_direction').'#about_clinic'; ?>"><span><?= lang('bf_about_nav_title');?></span></a></li>
            ...
            <div class="mob_nv_cont">
                ...
                <div class="mob_lks_cont">
                    ...
                    <ul class="mob_lks_list">
                        <li<?=($this->uri->segment(2) == null)?' class="active"':'';?>><a href="<?php echo site_url().'/'.lang('bf_language_direction'); ?>"><span><?= lang('bf_home_nav_title');?></span></a></li>
                        <?=($this->uri->segment(2) == 'about')?' class="active"':'';?>><a href="<?php echo site_url().'/'.lang('bf_language_direction').'/about'; ?>"><span><?= lang('bf_about_nav_title');?></span></a></li>
